...
<div class="container">
	...
	<?php
		...
		{
			$q=mysqli_query($db,"SELECT first,last,username,roll,email,contact,Branch FROM `student` where username like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT first,last,username,roll,email,contact,Branch FROM `student`;");
